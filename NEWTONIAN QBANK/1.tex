...
% ------------------------------------------
\begin{itemize}[label={}, leftmargin=1cm, itemsep=0.5em]
    \item[\textbf{A)}] ভরকেন্দ্রের ত্বরণ $a_{\text{cm}} = 0.658\text{ m/s}^2$
    \item[\textbf{B)}] ভরকেন্দ্রের ত্বরণ $a_{\text{cm}} = 1.420\text{ m/s}^2$
    \item[\textbf{C)}] ভরকেন্দ্রের ত্বরণ $a_{\text{cm}} = 2.100\text{ m/s}^2$
    \item[\textbf{D)}] ভরকেন্দ্রের ত্বরণ $a_{\text{cm}} = 0.312\text{ m/s}^2$
\end{itemize}

\vspace{0.5em}
\begin{tcolorbox}[answerbox]
    \textbf{\color{success} উত্তর:} A) ভরকেন্দ্রের ত্বরণ $a_{\text{cm}} = 0.658\text{ m/s}^2$
\end{tcolorbox}
\vspace{1em}
...
\begin{tcolorbox}[solutionbox={সমাধান (Solution)}]
    ...
    \end{align*}
    \textit{দ্রষ্টব্য: প্রশ্নের সমাধানের গাণিতিক অংশে দুটি আলাদা পরিস্থিতির ব্যাখ্যা দেওয়া হয়েছে, যা প্রদত্ত উত্তরের সাপেক্ষে প্রাসঙ্গিক।}
\end{tcolorbox}
