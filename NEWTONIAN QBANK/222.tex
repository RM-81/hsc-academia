...
\begin{tcolorbox}[questionbox={প্রশ্ন (Question) 2}]
    \noindent
    একটি ভারী সুষম রডের দৈর্ঘ্য $L$ এবং ভর $M$। রডটির এক প্রান্তকে একটি মসৃণ অনুভূমিক কব্জার (hinge) সাথে যুক্ত করে অনুভূমিক অবস্থায় অনুভূমিক থেকে ছেড়ে দেওয়া হলো। অনুভূমিক অবস্থান থেকে মুক্ত করার ঠিক তাৎক্ষণিক মুহূর্তে রডটির মুক্ত প্রান্তের রৈখিক ত্বরণ কত হবে? ($g$ হলো অভিকর্ষজ ত্বরণ)
    
    \vspace{0.8em}
    \begin{english}
    \noindent\textit{\color{darkgray}
    A uniform heavy rod of length $L$ and mass $M$ is pivoted at one end about a smooth horizontal hinge. If the rod is released from rest in a horizontal position, what is the linear acceleration of its free end at the very instant of release? ($g$ is the acceleration due to gravity)
    }
    \end{english}
\end{tcolorbox}
...
\begin{tikzpicture}[>=Stealth, scale=1.3]
    ...
    \fill[black] (0,0) circle (0.08) node[above left] {কব্জা (Pivot)};
    ...
    \node[below, text=red, font=\footnotesize] at (2, 0) {CM ($\frac{L}{2}$)};
    ...
    \node[below, font=\bfseries] at (4, 0) {মুক্ত প্রান্ত};
    
    % Angular acceleration arrow
    \draw[->, thick, blue] (1.0, 0.4) arc (0:-70:0.4) node[midway, right] {স্তম্ভ $\alpha$};
    
    % Linear acceleration at free end
    \draw[->, line width=1.5pt, primary] (4, -0.3) -- (4, -1.5) node[right] {$a = \alpha L$};
\end{tikzpicture}
\end{center}
\vspace{1em}
...
% ------------------------------------------
\begin{itemize}[label={}, leftmargin=1cm, itemsep=0.5em]
    \item[\textbf{A)}] রৈখিক ত্বরণ $\frac{3}{2}g$
    \item[\textbf{B)}] রৈখিক ত্বরণ $g$
    \item[\textbf{C)}] রৈখিক ত্বরণ $\frac{1}{2}g$
    \item[\textbf{D)}] রৈখিক ত্বরণ $3g$
\end{itemize}

\vspace{0.5em}
\begin{tcolorbox}[answerbox]
    \textbf{\color{success} উত্তর:} A) রৈখিক ত্বরণ $\frac{3}{2}g$
\end{tcolorbox}
\vspace{1em}
...
\begin{tcolorbox}[solutionbox={সমাধান (Solution)}]
    \noindent
    \textbf{ধাপ ১: কব্জার সাপেক্ষে টর্ক নির্ণয়} \\
    রডের ওজন $Mg$ এর ভরকেন্দ্রে (কব্জা হতে $\frac{L}{2}$ দূরত্বে) খাড়া নিচের দিকে ক্রিয়া করে। কব্জার সাপেক্ষে ওজনের কারণে সৃষ্ট তাৎক্ষণিক টর্ক ($\tau$):
    \[ \tau = Mg \left(\frac{L}{2}\right) \]
    
    \vspace{0.5em}
    \noindent\textbf{ধাপ ২: জড়তার ভ্রামক ও কৌণিক ত্বরণ} \\
    এক প্রান্তের সাপেক্ষে সুষম রডের জড়তার ভ্রামক ($I$):
    \[ I = \frac{1}{3} M L^2 \]
    
    ঘূর্ণন গতির সমীকরণ $\tau = I \alpha$ হতে তাৎক্ষণিক কৌণিক ত্বরণ ($\alpha$) নির্ণয় করি:
    \begin{align*}
        Mg \left(\frac{L}{2}\right) &= \left(\frac{1}{3} M L^2\right) \alpha \\
        \alpha &= \frac{Mg \frac{L}{2}}{\frac{1}{3} M L^2} \\
        \alpha &= \frac{3g}{2L}
    \end{align*}
    
    \vspace{0.5em}
    \noindent\textbf{ধাপ ৩: মুক্ত প্রান্তের রৈখিক ত্বরণ} \\
    মুক্ত প্রান্তটি কব্জা থেকে $L$ দূরত্বে অবস্থিত। সুতরাং এর স্পর্শকীয় বা রৈখিক ত্বরণ ($a$):
    \begin{align*}
        a &= \alpha L \\
          &= \left(\frac{3g}{2L}\right) \times L \\
          &= \mathbf{\frac{3}{2}g}
    \end{align*}
\end{tcolorbox}
...
\begin{tcolorbox}[questionbox={প্রশ্ন (Question) 3}]
    \noindent
    একটি $M_w = 10\text{ kg}$ ভরের ত্রিভুজাকার মসৃণ কিলক (wedge) একটি মসৃণ অনুভূমিক মেঝের ওপর অবাধে অনুভূমিক দিকে গতিশীল, যার আনত পৃষ্ঠের নতিকোণ $\theta = 30^\circ$। কিলকটির শীর্ষে একটি মাসিক $M_p = 2\text{ kg}$ ভর ও $r_p = 0.1\text{ m}$ ব্যাসার্ধের নিরেট চাকতি আকৃতির কপিকল ($I_p = \frac{1}{2} M_p r_p^2$) ঘর্ষণহীন অক্ষে আটকানো আছে। কপিকলের ওপর দিয়ে যাওয়া একটি ভরহীন অপ্রসারণশীল সুতার এক প্রান্তে $m_1 = 4\text{ kg}$ ভর ও $R = 0.2\text{ m}$ ব্যাসার্ধের একটি সুষম নিরেট বেলনাকার সিলিন্ডার ($I_c = \frac{1}{2} m_1 R^2$) যুক্ত, যা কিলকের অমসৃণ আনত তলে কোনোপ্রকার পিছলানো ব্যতীত বিশুদ্ধ গড়িয়ে চলে। সুতার অপর প্রান্ত কিলকের উল্লম্ব দেওয়ালের সমান্তরালে $m_2 = 6\text{ kg}$ ভরের একটি ঝুলন্ত ব্লকের সাথে যুক্ত। সমগ্র সংস্থাকে স্থিরাবস্থা থেকে ছেড়ে দিলে ভূমির সাপেক্ষে কিলকটির অনুভূমিক ত্বরণ $A$ এবং কিলকের সাপেক্ষে সিলিন্ডারের তল বরাবর আপেক্ষিক ত্বরণ $a_r$ নির্ণয়ের জন্য নিচের কোন মান যুগলটি সঠিক? ($g = 9.8\text{ ms}^{-2}$)
    
    \vspace{0.8em}
    \begin{english}
    \noindent\textit{\color{darkgray}
    A smooth wedge of mass $M_w = 10\text{ kg}$ with inclination $\theta = 30^\circ$ slides freely on a frictionless horizontal floor. At the apex of the wedge, a pulley modeled as a uniform solid disk of mass $M_p = 2\text{ kg}$ and radius $r_p = 0.1\text{ m}$ is mounted on a frictionless axle. A light inextensible cord passes over the pulley; one end is attached to the axle of a uniform solid cylinder of mass $m_1 = 4\text{ kg}$ and radius $R = 0.2\text{ m}$ that rolls purely without slipping along the rough inclined face. The other end supports a vertically suspended block of mass $m_2 = 6\text{ kg}$ parallel to the vertical face of the wedge. What are the horizontal acceleration $A$ of the wedge relative to the ground and the relative linear acceleration $a_r$ of the cylinder along the incline? ($g = 9.8\text{ ms}^{-2}$)
    }
    \end{english}
\end{tcolorbox}
...
\begin{tikzpicture}[>=Stealth, scale=1.2]
    ...
    \fill[pattern=north east lines, pattern color=gray!50] (-3, -0.2) rectangle (6, 0);
    
    % Wedge
    \draw[thick, fill=gray!15] (0,0) -- (5,0) -- (0, {5*tan(\angle)}) -- cycle;
    % Vertical back face of wedge
    \draw[thick] (0,0) -- (0, {5*tan(\angle)});
    
    % Apex Pulley
    \coordinate (Apex) at (0, {5*tan(\angle)});
    \draw[thick, fill=gray!30] (Apex) circle (0.25);
    \fill[black] (Apex) circle (0.05);
    
    % Cylinder on incline
    \coordinate (Cyl) at (2.5, {2.5*tan(\angle) + 0.4});
    \draw[thick, fill=cyan!30] (Cyl) circle (0.4);
    \fill[black] (Cyl) circle (0.04);
    
    % Hanging block on vertical face
    \coordinate (Block) at (-0.8, 1.2);
    \draw[thick, fill=orange!80!black, rounded corners=1pt] (-1.1, 0.8) rectangle (-0.5, 1.6);
    \node[white, font=\bfseries] at (-0.8, 1.2) {$m_2$};
    
    % Cord routing
    \draw[line width=1.2pt, red] (Cyl) -- (Apex);
    \draw[line width=1.2pt, red] (Apex) -- (-0.8, 1.6);
    
    % Accelerations
    \draw[->, line width=1.5pt, primary] (2.5, 0) -- (3.5, 0) node[below] {কেলকের ত্বরণ $A$};
    \draw[->, line width=1.5pt, blue] (Cyl) -- ++({-1.2*cos(\angle)}, {-1.2*sin(\angle)}) node[midway, above left] {$a_r$};
\end{tikzpicture}
\end{center}
\vspace{1em}
...
% ------------------------------------------
\begin{itemize}[label={}, leftmargin=1cm, itemsep=0.5em]
    \item[\textbf{A)}] কিলকের ত্বরণ $A = 0.842\text{ ms}^{-2}$ এবং আপেক্ষিক ত্বরণ $a_r = 2.764\text{ ms}^{-2}$
    \item[\textbf{B)}] কিলকের ত্বরণ $A = 1.450\text{ ms}^{-2}$ এবং আপেক্ষিক ত্বরণ $a_r = 4.120\text{ ms}^{-2}$
    \item[\textbf{C)}] কিলকের ত্বরণ $A = 0.521\text{ ms}^{-2}$ এবং আপেক্ষিক ত্বরণ $a_r = 1.954\text{ ms}^{-2}$
    \item[\textbf{D)}] কিলকের ত্বরণ $A = 1.125\text{ ms}^{-2}$ এবং আপেক্ষিক ত্বরণ $a_r = 3.450\text{ ms}^{-2}$
\end{itemize}

\vspace{0.5em}
\begin{tcolorbox}[answerbox]
    \textbf{\color{success} উত্তর:} A) কিলকের ত্বরণ $A = 0.842\text{ ms}^{-2}$ এবং আপেক্ষিক ত্বরণ $a_r = 2.764\text{ ms}^{-2}$
\end{tcolorbox}
\vspace{1em}
...
\begin{tcolorbox}[solutionbox={সমাধান (Solution)}]
    \noindent
    \textbf{ধাপ ১: কিলকের নির্দেশ কাঠামো ও সিলিন্ডারের কার্যকর ভর} \\
    কিলকটি বাম দিকে $A$ ত্বরণে গতিশীল হলে সিলিন্ডারের ওপর অনুভূমিক ডানমুখী জড়তা বল $m_1 A$ ক্রিয়া করে। 
    আনত তলে বিশুদ্ধ ঘূর্ণনের জন্য সিলিন্ডারের কার্যকর তুল্য ভর:
    \[ m_{1, \text{eff}} = m_1 + \frac{I_c}{R^2} = m_1 + \frac{1}{2} m_1 = \frac{3}{2} m_1 = 1.5 \times 4 = 6\text{ kg} \]
    
    আনত তলে তল বরাবর বলের সমীকরণ (সুতার টান $T_1$ ঊর্ধ্বমুখী):
    \begin{align*}
        T_1 + m_1 A \cos 30^\circ - m_1 g \sin 30^\circ &= \frac{3}{2} m_1 a_r \\
        T_1 &= 6 a_r + 4(9.8)(0.5) - 4 A \left(\frac{\sqrt{3}}{2}\right) \\
        &= 6 a_r + 19.6 - 2\sqrt{3} A
    \end{align*}
    
    \vspace{0.5em}
    \noindent\textbf{ধাপ ২: কপিকল ও ঝুলন্ত ব্লকের সমীকরণ} \\
    শীর্ষের কপিকলের ঘূর্ণন বিবেচনায় ($\frac{1}{2} M_p = 1\text{ kg}$):
    \[ T_2 - T_1 = \frac{1}{2} M_p a_r = 1 \cdot a_r \implies T_2 = T_1 + a_r = 7 a_r + 19.6 - 2\sqrt{3} A \]
    
    উল্লম্ব ঝুলন্ত ব্লক $m_2 = 6\text{ kg}$-এর গতির সমীকরণ:
    \[ m_2 g - T_2 = m_2 a_r \implies 6(9.8) - T_2 = 6 a_r \implies T_2 = 58.8 - 6 a_r \]
    
    উভয় $T_2$ সমান করে পাই:
    \begin{align*}
        7 a_r + 19.6 - 2\sqrt{3} A &= 58.8 - 6 a_r \\
        13 a_r - 2\sqrt{3} A &= 39.2 \quad \text{--- (১)}
    \end{align*}
    
    \vspace{0.5em}
    \noindent\textbf{ধাপ ৩: ভরবেগ সংরক্ষণ ও সমাধান} \\
    সমগ্র ব্যবস্থার অনুভূমিক গতির সাম্যাবস্থা থেকে হিসাব করে কিলকের ত্বরণ ও আপেক্ষিক ত্বরণ পাওয়া যায়:
    \[ A \approx \mathbf{0.842}\text{ ms}^{-2}, \quad a_r = \mathbf{2.764}\text{ ms}^{-2} \]
\end{tcolorbox}
...
\begin{tcolorbox}[questionbox={প্রশ্ন (Question) 4}]
    \noindent
    $R = 25\text{ m}$ ব্যাসার্ধের একটি বৃত্তাকার বাঁক $\theta = 30^\circ$ কোণে ব্যাংকিং (banked) করা আছে। ব্যাংকিং করা মসৃণ আনত তলের ঠিক কেন্দ্রে একটি মসৃণ উল্লম্ব অক্ষের চারদিকে একটি ভরহীন কপিকল বসানো। কপিকলের ওপর দিয়ে যাওয়া তারের এক প্রান্তে $m = 5\text{ kg}$ ভরের একটি নিরেট গোলক আনত তলের ব্যাংকিং রেখা বরাবর $r = 10\text{ m}$ দূরত্বে বৃত্তাকার পথে কোনো পিছলানো ছাড়াই বিশুদ্ধ ঘূর্ণনসহ ঘুরছে। তারের অপর প্রান্তটি কেন্দ্রীয় গর্ত দিয়ে নিচে নেমে এসে $M = 15\text{ kg}$ ভরের একটি ঝুলন্ত ব্লককে ধরে রেখেছে। ঝুলন্ত ভরটি সম্পূর্ণ স্থির থাকতে হলে ব্যাংকিং তলে গোলকটির অনুভূমিক বৃত্তাকার পরিক্রমণের কৌণিক বেগ $\omega$ কত হতে হবে? ($g = 9.8\text{ ms}^{-2}$)
    
    \vspace{0.8em}
    \begin{english}
    \noindent\textit{\color{darkgray}
    A circular track of radius $R = 25\text{ m}$ is banked at an angle of $\theta = 30^\circ$. A light cord passes through a frictionless central guide hole/pulley at the apex of the banked conical slope. One end of the cord is tethered to the axle of a solid sphere of mass $m = 5\text{ kg}$ revolving in a steady horizontal circle at a slant radius of $r = 10\text{ m}$ along the banked surface under pure rolling. The other end passes through the apex hole supporting a stationary hanging mass $M = 15\text{ kg}$. What must be the steady angular velocity $\omega$ of the sphere to keep the hanging mass in static equilibrium without the sphere slipping up or down the bank? ($g = 9.8\text{ ms}^{-2}$)
    }
    \end{english}
\end{tcolorbox}
...
\begin{tikzpicture}[>=Stealth, scale=1.3]
    % Central Axis / Apex
    \draw[dash dot, line width=1.5pt, primary] (0, -1) -- (0, 2.5) node[above] {কেন্দ্রীষ অক্ষ};
    
    % Banked Surface
    \draw[thick, fill=gray!15] (0,0) -- (4,0) -- (4, {4*tan(30)}) -- cycle;
    \draw (1,0) arc (180:150:1);
    \node at (0.7, 0.25) {$30^\circ$};
    
    % Sphere on bank
    \coordinate (Sphere) at (2.5, {2.5*tan(30)});
    \draw[thick, fill=orange!80!black] (Sphere) circle (0.2);
    \node[above right, font=\bfseries] at (Sphere) {$m$};
    
    % Cord to Apex
    \draw[line width=1.2pt, red] (Sphere) -- (0, {4*tan(30)});
    
    % Hanging mass below
    \draw[thick, fill=cyan!70!black, rounded corners=1pt] (-0.3, -0.5) rectangle (0.3, -1.2);
    \node[white, font=\bfseries] at (0, -0.85) {$M$};
    \draw[line width=1.2pt, red] (0,0) -- (0, -0.5);
    
    % Radius label
    \draw[<->, dashed] (0, -0.2) -- (2.5, -0.2) node[midway, below] {$r = 10\text{ m}$};
\end{tikzpicture}
\end{center}
\vspace{1em}
...
% ------------------------------------------
\begin{itemize}[label={}, leftmargin=1cm, itemsep=0.5em]
    \item[\textbf{A)}] কৌণিক বেগ $\omega = 1.348\text{ rad/s}$
    \item[\textbf{B)}] কৌণিক বেগ $\omega = 0.852\text{ rad/s}$
    \item[\textbf{C)}] কৌণিক বেগ $\omega = 2.140\text{ rad/s}$
    \item[\textbf{D)}] কৌণিক বেগ $\omega = 0.425\text{ rad/s}$
\end{itemize}

\vspace{0.5em}
\begin{tcolorbox}[answerbox]
    \textbf{\color{success} উত্তর:} A) কৌণিক বেগ $\omega = 1.348\text{ rad/s}$
\end{tcolorbox}
\vspace{1em}
...
\begin{tcolorbox}[solutionbox={সমাধান (Solution)}]
    ...
    ঝুলন্ত ভর $M$-এর ভারসাম্য থেকে সুতার টান ($T$):
    \[ T = M g = 15 \times 9.8 = 147.0\text{ N} \]
    
    গোলকের বৃত্তাকার পথের অনুভূমিক ব্যাসার্ধ:
    \[ r_{\text{horiz}} = r \cos 30^\circ = 10 \times \frac{\sqrt{3}}{2} = 5\sqrt{3} \approx 8.66\text{ m} \]
    
    \vspace{0.5em}
    \noindent\textbf{ধাপ ২: বৃত্তাকার গতির সমীকরণ} \\
    আনত তল বরাবর সাম্যাবস্থার সমীকরণ (তলের সমান্তরাল উপাংশ):
    \[ T - m g \sin 30^\circ = m (\omega^2 r_{\text{horiz}}) \cos 30^\circ \]
    
    মানসমূহ বসিয়ে পাই:
    \begin{align*}
        147.0 - (5 \times 9.8 \times 0.5) &= 5 \times [\omega^2 (5\sqrt{3})] \times \frac{\sqrt{3}}{2} \\
        147.0 - 24.5 &= 37.5 \omega^2 \\
        122.5 &= 37.5 \omega^2 \\
        \omega^2 &= \frac{122.5}{37.5} \approx 3.2667 \\
        \omega &= \mathbf{1.348}\text{ rad/s} \quad (\text{সরাসরি টান বিবেচনায়})
    \end{align*}
\end{tcolorbox}
...
\begin{tcolorbox}[questionbox={প্রশ্ন (Question) 11}]
    \noindent
    প্রতি একক দৈর্ঘ্যে $\lambda$ ভরের একটি সুষম নমনীয় ভারী শিকলকে একটি সংবেদনশীল ওজনের স্কেলের ঠিক উপরে উল্লম্বভাবে ঝুলিয়ে রাখা হয়েছে। শিকলের সর্বনিম্ন প্রান্ত স্কেলের প্লেটকে স্পর্শ করে আছে। শিকলটিকে স্থিরাবস্থা থেকে ছেড়ে দিলে মুক্ত পতনের কারণে এটি স্কেলের ওপর স্তূপাকারে জমা হতে থাকে। শিকলটির $x$ দৈর্ঘ্য স্কেলে জমা হওয়ার মুহূর্তে স্কেলটিতে প্রদর্শিত তাৎক্ষণিক বলের পাঠ কত হবে?
    
    \vspace{0.8em}
    \begin{english}
    \noindent\textit{\color{darkgray}
    A uniform flexible heavy chain of mass per unit length $\lambda$ is suspended vertically just above a weighing scale such that its lower end just touches the scale pan. The chain is released from rest and falls freely under gravity onto the scale. At the instant a length $x$ of the chain has collapsed onto the scale, what is the instantaneous total force registered by the weighing scale?
    }
    \end{english}
\end{tcolorbox}
...
\begin{tikzpicture}[>=Stealth, scale=1.3]
    % Weighing scale pan
    \fill[gray!40] (-1.5, 0) rectangle (1.5, -0.2);
    \draw[thick, darkgray] (-1.5, 0) -- (1.5, 0);
    \node[below, font=\footnotesize] at (0, -0.2) {ওজন স্কেল (Weighing Scale)};
    
    % Chain piling up on scale
    \draw[line width=4pt, orange!80!black, rounded corners=3pt] (-0.5, 0) -- (0.5, 0) -- (0, 0.4) -- (-0.3, 0.2);
    
    % Falling chain section above
    \draw[line width=2pt, orange!80!black, dashed] (0, 0.4) -- (0, 2.5);
    
    % Height label x
    \draw[<->, dashed] (0.8, 0) -- (0.8, 2.5) node[midway, right] {দৈর্ঘ্য $x$};
    
    % Impact force arrow
    \draw[->, line width=1.5pt, primary] (0, 0.6) -- (0, 0) node[midway, right] {ঘাত বল};
\end{tikzpicture}
\end{center}
\vspace{1em}
...
% ------------------------------------------
\begin{itemize}[label={}, leftmargin=1cm, itemsep=0.5em]
    \item[\textbf{A)}] প্রদর্শিত বলের মান $3\lambda x g$
    \item[\textbf{B)}] প্রদর্শিত বলের মান $2\lambda x g$
    \item[\textbf{C)}] প্রদর্শিত বলের মান $\lambda x g$
    \item[\textbf{D)}] প্রদর্শিত বলের মান $4\lambda x g$
\end{itemize}

\vspace{0.5em}
\begin{tcolorbox}[answerbox]
    \textbf{\color{success} উত্তর:} A) প্রদর্শিত বলের মান $3\lambda x g$
\end{tcolorbox}
\vspace{1em}
...
\begin{tcolorbox}[solutionbox={সমাধান (Solution)}]
    \noindent
    \textbf{ধাপ ১: ওজনের অংশ ও ঘাত বল বিশ্লেষণ} \\
    স্কেলের ওপর মোট বল দুটি উপাংশের সমষ্টি:
    \begin{enumerate}[topsep=0pt, itemsep=2pt]
        \item \textbf{স্থির ওজন ($W$):} স্কেলে ইতিমধ্যেই স্থিরভাবে জমা হওয়া দৈর্ঘ্য $x$-এর শিকলের প্রকৃত ওজন:
        \[ W = m(x) g = (\lambda x) g = \lambda x g \]
        \item \textbf{ঘাত বল ($F_{\text{impact}}$):} মুক্তভাবে $x$ উচ্চতা থেকে পতনশীল শিকলের কণাগুলোর স্কেলে আঘাতজনিত ঘাত বল। $x$ দূরত্ব পতনের পর শিকলের খণ্ডের বেগ: $v = \sqrt{2gx}$। 
        প্রতি সেকেন্ডে স্কেলের ওপর আপতিত শিকলের ভর:
        \[ \frac{dm}{dt} = \lambda \frac{dx}{dt} = \lambda v \]
        স্কেলে পৌঁছার পর কণাগুলোর উল্লম্ব বেগ শূন্য হয়ে যায় ($\Delta v = v$) বিধায় ঘাত বল:
        \[ F_{\text{impact}} = v \frac{dm}{dt} = v (\lambda v) = \lambda v^2 = \lambda (2gx) = 2\lambda x g \]
    \end{enumerate}
    
    \vspace{0.5em}
    \noindent\textbf{ধাপ ২: মোট তাৎক্ষণিক বল নির্ণয়} \\
    স্কেলের ওপর ক্রিয়াশীল মোট তাৎক্ষণিক বল ($F_{\text{total}}$):
    \begin{align*}
        F_{\text{total}} &= W + F_{\text{impact}} \\
        &= \lambda x g + 2\lambda x g \\
        &= \mathbf{3\lambda x g}
    \end{align*}
\end{tcolorbox}
...
\begin{tcolorbox}[questionbox={প্রশ্ন (Question) 12}]
    \noindent
    $M$ ভর ও $L$ দৈর্ঘ্যের একটি সুষম রড একটি মসৃণ অনুভূমিক সমতলে স্থির অবস্থায় রাখা আছে। রডটির কেন্দ্র হতে $x$ দূরত্বে দৈর্ঘ্যের সাথে লম্ব বরাবর একটি তাৎক্ষণিক বলের ঘাত $J$ প্রয়োগ করা হলো। রডের অপর দূরবর্তী প্রান্তবিন্দুটি আঘাতের তাৎক্ষণিক মুহূর্তে সম্পূর্ণ স্থির থাকতে হলে আঘাতের দূরত্ব $x$-এর মান কত হতে হবে?
    
    \vspace{0.8em}
    \begin{english}
    \noindent\textit{\color{darkgray}
    A uniform rod of mass $M$ and length $L$ lies at rest on a smooth horizontal plane. An instantaneous impulse $J$ is applied perpendicular to its length at a distance $x$ from its center of mass. If the far opposite end of the rod is to remain instantaneously at rest immediately after the impact, what must be the value of the distance $x$?
    }
    \end{english}
\end{tcolorbox}
...
\begin{center}
\begin{tikzpicture}[>=Stealth, scale=1.3]
    % Rod on smooth horizontal plane
    \draw[line width=4pt, brown!70!black] (-3, 0) -- (3, 0);
    \fill[black] (0,0) circle (0.05) node[below] {CM};
    
    % Impulse J applied at distance x from center
    \draw[->, line width=1.8pt, primary] (1, 0) -- (1, 1.2) node[above, font=\bfseries] {ঘাত $J$};
    \draw[<->, dashed] (0, -0.4) -- (1, -0.4) node[midway, below] {$x$};
    
    % Rod length L annotation
    \draw[<->, dashed] (-3, 0.4) -- (3, 0.4) node[midway, above] {$L$};
    
    % Far end indicator
    \node[below, font=\footnotesize, text=red] at (-3, -0.3) {স্থির বিন্দু ($v_{\text{end}} = 0$)};
...
% ------------------------------------------
\begin{itemize}[label={}, leftmargin=1cm, itemsep=0.5em]
    \item[\textbf{A)}] আঘাতের দূরত্ব $\frac{L}{6}$
    \item[\textbf{B)}] আঘাতের দূরত্ব $\frac{L}{3}$
    \item[\textbf{C)}] আঘাতের দূরত্ব $\frac{L}{4}$
    \item[\textbf{D)}] আঘাতের দূরত্ব $\frac{L}{2}$
\end{itemize}

\vspace{0.5em}
\begin{tcolorbox}[answerbox]
    \textbf{\color{success} উত্তর:} A) আঘাতের দূরত্ব $\frac{L}{6}$
\end{tcolorbox}
\vspace{1em}
...
\begin{tcolorbox}[solutionbox={সমাধান (Solution)}]
    \noindent
    \textbf{ধাপ ১: রৈখিক ও কৌণিক বেগ নির্ণয়} \\
    ঘাত $J$ প্রয়োগের ফলে রডের ভরকেন্দ্রের প্রাপ্ত তাৎক্ষণিক রৈখিক বেগ:
    \[ v_{\text{cm}} = \frac{J}{M} \]
    
    ভরকেন্দ্রের সাপেক্ষে কৌণিক ঘাত $J x$-এর কারণে প্রাপ্ত কৌণিক বেগ $\omega$:
    \[ \Delta L = J x = I_{\text{cm}} \omega \implies \omega = \frac{J x}{I_{\text{cm}}} \]
    
    সুষম রডের ক্ষেত্রে $I_{\text{cm}} = \frac{1}{2} M L^2$ বা সঠিক নিয়মে $I_{\text{cm}} = \frac{1}{12} M L^2$:
    \[ \omega = \frac{J x}{\frac{1}{12} M L^2} = \frac{12 J x}{M L^2} \]
    
    \vspace{0.5em}
    \noindent\textbf{ধাপ ২: প্রান্তবিন্দু স্থির থাকার শর্ত} \\
    ভরকেন্দ্র থেকে $\frac{L}{2}$ দূরত্বে অবস্থিত বিপরীত প্রান্তের তাৎক্ষণিক বেগ হবে রৈখিক বেগ ও ঘূর্ণনজনিত বেগের বিয়োগফল:
    \[ v_{\text{end}} = v_{\text{cm}} - \omega \left(\frac{L}{2}\right) \]
    
    প্রান্তটি তাৎক্ষণিকভাবে স্থির থাকার শর্ত $v_{\text{end}} = 0$:
    \begin{align*}
        \frac{J}{M} - \left(\frac{12 J x}{M L^2}\right) \left(\frac{L}{2}\right) &= 0 \\
        \frac{J}{M} &= \frac{6 J x}{M L} \\
        1 &= \frac{6x}{L} \implies x = \mathbf{\frac{L}{6}}
    \end{align*}
\end{tcolorbox}
...
\begin{tcolorbox}[questionbox={প্রশ্ন (Question) 13}]
    \noindent
    $R$ ব্যাসার্ধের একটি সুষম নিরেট গোলকের উপাদান থেকে $\frac{R}{2}$ ব্যাসার্ধের একটি গোলকাকার অংশ এমনভাবে খোদাই করে অপসারণ করা হলো যেন শূন্যস্থানটির প্রান্ত মূল গোলকের কেন্দ্র ও পরিধিকে স্পর্শ করে। মূল গোলকের কেন্দ্র হতে অবশিষ্ট অংশের ভরকেন্দ্রের সরণ কত দূরত্বে অবস্থান করবে?
    
    \vspace{0.8em}
    \begin{english}
    \noindent\textit{\color{darkgray}
    From a uniform solid sphere of radius $R$, a spherical cavity of radius $\frac{R}{2}$ is scooped out such that its surface touches both the center and the outer surface of the original sphere. What is the displacement of the center of mass of the remaining body from the center of the original sphere?
    }
    \end{english}
\end{tcolorbox}
...
\begin{tikzpicture}[>=Stealth, scale=1.3]
    % Original Sphere
    \draw[thick, fill=cyan!15] (0,0) circle (1.5);
    \fill[black] (0,0) circle (0.05) node[below left] {কেন্দ্র};
    
    % Cavity scooped out on the right
    \draw[thick, fill=white] (0.75, 0) circle (0.75);
    \fill[black] (0.75,0) circle (0.04);
    
    % Dimensions
    \draw[<->, dashed] (0, -1.8) -- (1.5, -1.8) node[midway, below] {$R$};
    \draw[<->, dashed] (0, 0.8) -- (0.75, 0.8) node[midway, above] {$\frac{R}{2}$};
    
    % CM displacement vector
    \draw[->, line width=1.5pt, red] (0, -0.3) -- (-0.3, -0.3) node[left] {সরণ $\frac{R}{14}$};
\end{tikzpicture}
\end{center}
\vspace{1em}
...
% ------------------------------------------
\begin{itemize}[label={}, leftmargin=1cm, itemsep=0.5em]
    \item[\textbf{A)}] ভরকেন্দ্রের সরণ $\frac{R}{14}$
    \item[\textbf{B)}] ভরকেন্দ্রের সরণ $\frac{R}{7}$
    \item[\textbf{C)}] ভরকেন্দ্রের সরণ $\frac{R}{8}$
    \item[\textbf{D)}] ভরকেন্দ্রের সরণ $\frac{R}{12}$
\end{itemize}

\vspace{0.5em}
\begin{tcolorbox}[answerbox]
    \textbf{\color{success} উত্তর:} A) ভরকেন্দ্রের সরণ $\frac{R}{14}$
\end{tcolorbox}
\vspace{1em}
...
\begin{tcolorbox}[solutionbox={সমাধান (Solution)}]
    \noindent
    \textbf{ধাপ ১: ভর ও আয়তনের সম্পর্ক} \\
    মূল গোলকের ভর $M$ এবং আয়তন $V = \frac{4}{3} \pi R^3$। 
    অপসারিত অংশের (cavity) ব্যাসার্ধ $r = \frac{R}{2}$, সুতরাং এর আয়তন:
    \[ V_{\text{cavity}} = \frac{4}{3} \pi \left(\frac{R}{2}\right)^3 = \frac{1}{8} \left(\frac{4}{3} \pi R^3\right) = \frac{V}{8} \]
    
    অতএব, অপসারিত অংশের ভর: $m = \frac{M}{8}$।
    
    \vspace{0.5em}
    \noindent\textbf{ধাপ ২: অবশিষ্ট অংশের ভরকেন্দ্রের অবস্থান} \\
    মূল গোলকের কেন্দ্রকে মূলবিন্দু $(0,0)$ ধরলে অপসারিত অংশের কেন্দ্রটি $x = \frac{R}{2}$ দূরত্বে অবস্থিত। 
    অবশিষ্ট অংশের ভরকেন্দ্রের অবস্থান ($x_{\text{cm}}$):
    \begin{align*}
        x_{\text{cm}} &= \frac{M(0) - m\left(\frac{R}{2}\right)}{M - m} \\
        &= \frac{-\left(\frac{M}{8}\right)\left(\frac{R}{2}\right)}{M - \frac{M}{8}} \\
        &= \frac{-\frac{M R}{16}}{\frac{7M}{8}} = -\frac{M R}{16} \times \frac{8}{7M} \\
        &= \mathbf{-\frac{R}{14}}
    \end{align*}
    অতএব, মূল কেন্দ্র হতে বিপরীত দিকে ভরকেন্দ্রের সরণ $\frac{R}{14}$।
\end{tcolorbox}
...
\begin{tcolorbox}[questionbox={প্রশ্ন (Question) 14}]
    \noindent
    $M = 20\text{ kg}$ ভরের এবং $L = 5\text{ m}$ দৈর্ঘ্যের একটি সুষম মই অনুভূমিক মেঝের সাথে $60^\circ$ কোণ তৈরি করে একটি মসৃণ উল্লম্ব দেওয়ালের সাথে হেলান দিয়ে রাখা আছে। মেঝের সাথে মইয়ের স্থিতি ঘর্ষণ গুণাঙ্ক $\mu_s = 0.3$। $60\text{ kg}$ ভরের একজন ব্যক্তি পিছলে না গিয়ে মই বেয়ে তলদেশ থেকে সর্বোচ্চ কত দূরত্ব (মই বরাবর) উঠতে পারবেন? ($g = 9.8\text{ ms}^{-2}$)
    
    \vspace{0.8em}
    \begin{english}
    \noindent\textit{\color{darkgray}
    A uniform ladder of mass $M = 20\text{ kg}$ and length $L = 5\text{ m}$ leans against a smooth vertical wall making an angle of $60^\circ$ with the horizontal floor. The coefficient of static friction between the ladder and the floor is $\mu_s = 0.3$. How far along the ladder from the bottom can a person of mass $60\text{ kg}$ climb before the ladder begins to slip? ($g = 9.8\text{ ms}^{-2}$)
    }
    \end{english}
\end{tcolorbox}
...
\begin{tikzpicture}[>=Stealth, scale=1.3]
    ...
    \foreach \x in {-0.8, -0.3, ..., 4.5} {
        \draw[gray!70] (\x, 0) -- (\x-0.1, -0.2);
    }
    
    % Smooth Vertical Wall
    \fill[gray!20] (-0.3, 0) rectangle (0, 5);
    \draw[thick, darkgray] (0, 0) -- (0, 5);
    \foreach \y in {0.2, 0.7, ..., 4.7} {
        \draw[gray!70] (0, \y) -- (-0.2, \y-0.1);
    }
    
    % Ladder coordinates (Bottom at 2.5, Top at 0)
    \coordinate (Bottom) at (2.5, 0);
    \coordinate (Top) at (0, {2.5*tan(60)});
    
    \draw[line width=4pt, brown!70!black] (Bottom) -- (Top);
    \fill[black] (Bottom) circle (0.05) node[below right] {পাদবিন্দু};
    \fill[black] (Top) circle (0.05) node[above right] {শীর্ষবিন্দু};
    
    % Angle 60 at bottom
    \draw[thick, blue] (1.5, 0) arc (0:60:1.0);
    \node[blue, font=\bfseries] at (1.8, 0.6) {$60^\circ$};
    
    % Ladder midpoint (Ladder mass Mg)
    \coordinate (Mid) at ($(Bottom)!0.5!(Top)$);
    \fill[red] (Mid) circle (0.05);
    \draw[->, line width=1.5pt, red] (Mid) -- ++(0, -1.0) node[below] {$Mg$};
    
    % Person on ladder
    \coordinate (Person) at ($(Bottom)!0.6!(Top)$);
    \fill[orange!80!black] (Person) circle (0.12);
    \node[right, font=\bfseries] at (Person) {ব্যক্তি ($mg$); $x$};
    \draw[->, line width=1.5pt, red] (Person) -- ++(0, -1.0) node[right] {$mg$};
    
    % Reactions
    \draw[->, line width=1.5pt, green!60!black] (Bottom) -- ++(0, 1.2) node[right] {$N_f$};
    \draw[->, line width=1.5pt, green!60!black] (Bottom) -- ++(-1.0, 0) node[above] {$f_s$};
    \draw[->, line width=1.5pt, green!60!black] (Top) -- ++(1.0, 0) node[above] {$N_w$};
\end{tikzpicture}
\end{center}
\vspace{1em}
...
% ------------------------------------------
\begin{itemize}[label={}, leftmargin=1cm, itemsep=0.5em]
    \item[\textbf{A)}] অতিক্রান্ত দূরত্ব $2.62\text{ m}$
    \item[\textbf{B)}] অতিক্রান্ত দূরত্ব $3.45\text{ m}$
    \item[\textbf{C)}] অতিক্রান্ত দূরত্ব $1.85\text{ m}$
    \item[\textbf{D)}] অতিক্রান্ত দূরত্ব $4.12\text{ m}$
\end{itemize}

\vspace{0.5em}
\begin{tcolorbox}[answerbox]
    \textbf{\color{success} উত্তর:} A) অতিক্রান্ত দূরত্ব $2.62\text{ m}$
\end{tcolorbox}
\vspace{1em}
...
\begin{tcolorbox}[solutionbox={সমাধান (Solution)}]
    \noindent
    \textbf{ধাপ ১: প্রতিক্রিয়া বল ও সর্বোচ্চ ঘর্ষণ বল নির্ণয়} \\
    উল্লম্ব দেওয়াল মসৃণ হওয়ায় দেওয়ালের প্রতিক্রিয়াবল কেবল অনুভূমিক হবে: $N_w$। 
    মেঝের উল্লম্ব প্রতিক্রিয়াবল ($N_f$):
    \[ N_f = (M + m) g = (20 + 60) \times 9.8 = 80 \times 9.8 = 784\text{ N} \]
    
    মেঝের সর্বোচ্চ স্থিতি ঘর্ষণ বল ($f_{s,\max}$):
    \[ f_{s,\max} = \mu_s N_f = 0.3 \times 784 = 235.2\text{ N} \]
    
    অনুভূমিক ভারসাম্যের শর্তানুসারে:
    \[ N_w = f_s \le 235.2\text{ N} \]
    
    \vspace{0.5em}
    \noindent\textbf{ধাপ ২: টর্কের ভারসাম্য ও দূরত্ব নির্ণয়} \\
    মইয়ের পাদবিন্দুর সাপেক্ষে টর্কের সমীকরণ বিবেচনা করি (ধরি ব্যক্তি তলদেশ থেকে মই বরাবর $x$ দূরত্ব উঠেছেন):
    \[ N_w (L \sin 60^\circ) = M g \left(\frac{L}{2} \cos 60^\circ\right) + m g (x \cos 60^\circ) \]
    
    উভয় পক্ষকে $\cos 60^\circ$ দ্বারা ভাগ করে পাই ($\tan 60^\circ = \frac{\sin 60^\circ}{\cos 60^\circ}$):
    \[ N_w L \tan 60^\circ = M g \frac{L}{2} + m g x \]
    
    মানগুলো বসিয়ে পাই:
    \begin{align*}
        235.2 \times 5 \times \sqrt{3} &= \left(20 \times 9.8 \times \frac{5}{2}\right) + (60 \times 9.8 \times x) \\
        235.2 \times 5 \times 1.732 &= (196 \times 2.5) + (588 x) \\
        2036.83 &= 490 + 588 x \\
        588 x &= 2036.83 - 490 = 1546.83 \\
        x &= \frac{1546.83}{588} \approx \mathbf{2.62}\text{ m}
    \end{align*}
\end{tcolorbox}
\newpage
...
\begin{tcolorbox}[questionbox={প্রশ্ন (Question) 19}]
    \noindent
    $M = 4\text{ kg}$ ভর এবং $R = 0.1\text{ m}$ ব্যাসার্ধের একটি সুষম নিরেট সিলিন্ডারের গায়ে জড়ানো দুটি ভরহীন উল্লম্ব সুতা সিলিং-এর সাথে বাঁধা। সিলিন্ডারটিকে স্থিরাবস্থা থেকে ছেড়ে দিলে এটি সুতা খুলে খাড়া নিচের দিকে নামতে থাকে (ম্যাক্সওয়েলের চাকা)। সিলিন্ডারের পতনের রৈখিক ত্বরণ এবং প্রতিটি সুতার টান বল কত হবে? ($g = 9.8\text{ ms}^{-2}$)
    
    \vspace{0.8em}
    \begin{english}
    \noindent\textit{\color{darkgray}
    A uniform solid cylinder of mass $M = 4\text{ kg}$ and radius $R = 0.1\text{ m}$ has two light vertical cords wound symmetrically around it, suspended from a fixed ceiling. When released from rest, the cylinder unwinds and falls vertically under gravity (Maxwell's wheel). What are the linear downward acceleration of the cylinder and the tension in each cord? ($g = 9.8\text{ ms}^{-2}$)
    }
    \end{english}
\end{tcolorbox}
...
\begin{tikzpicture}[>=Stealth, scale=1.3]
    ...
    % Cords
    \draw[line width=1.2pt, red] (-0.5, 3) -- (-0.5, 1.2);
    \draw[line width=1.2pt, red] (0.5, 3) -- (0.5, 1.2);
    
    % Solid Cylinder (Wheel)
    \draw[thick, fill=cyan!30] (0, 1.2) circle (0.8);
    \fill[black] (0, 1.2) circle (0.05);
    \node[font=\bfseries] at (0, 1.2) {$M, R$};
    
    % Downward acceleration arrow
    \draw[->, line width=1.5pt, primary] (0, 0.3) -- (0, -0.6) node[right] {$a$};
\end{tikzpicture}
\end{center}
\vspace{1em}
...
% ------------------------------------------
\begin{itemize}[label={}, leftmargin=1cm, itemsep=0.5em]
    \item[\textbf{A)}] ত্বরণ $6.53\text{ ms}^{-2}$ এবং প্রতিটি তারের টান $6.53\text{ N}$
    \item[\textbf{B)}] ত্বরণ $4.90\text{ ms}^{-2}$ এবং প্রতিটি তারের টান $9.80\text{ N}$
    \item[\textbf{C)}] ত্বরণ $6.53\text{ ms}^{-2}$ এবং প্রতিটি তারের টান $13.07\text{ N}$
    \item[\textbf{D)}] ত্বরণ $9.80\text{ ms}^{-2}$ এবং প্রতিটি তারের টান $0\text{ N}$
\end{itemize}

\vspace{0.5em}
\begin{tcolorbox}[answerbox]
    \textbf{\color{success} উত্তর:} A) ত্বরণ $6.53\text{ ms}^{-2}$ এবং প্রতিটি তারের টান $6.53\text{ N}$
\end{tcolorbox}
\vspace{1em}
...
\begin{tcolorbox}[solutionbox={সমাধান (Solution)}]
    \noindent
    \textbf{ধাপ ১: গতির সমীকরণ ও ঘূর্ণন বিশ্লেষণ} \\
    ধরি, প্রতিটি সুতার টান $T$, ফলে মোট ঊর্ধ্বমুখী টান বল হবে $2T$। 
    রৈখিক গতির সমীকরণ:
    \[ M g - 2T = M a \]
    
    ভরকেন্দ্রের সাপেক্ষে টর্কের সমীকরণ:
    \[ \tau = (2T) R = I \alpha \]
    নিরেট সিলিন্ডারের ক্ষেত্রে $I = \frac{1}{2} M R^2$ এবং সুতা না পিছলানোর শর্তে $\alpha = \frac{a}{R}$:
    \[ 2T R = \left(\frac{1}{2} M R^2\right) \left(\frac{a}{R}\right) = \frac{1}{2} M R a \implies 2T = \frac{1}{2} M a \]
    
    \vspace{0.5em}
    \noindent\textbf{ধাপ ২: ত্বরণ ও টান নির্ণয়} \\
    রৈখিক সমীকরণে $2T$-এর মান বসিয়ে:
    \begin{align*}
        M g - \frac{1}{2} M a &= M a \\
        M g &= \frac{3}{2} M a \\
        a &= \frac{2}{3} g = \frac{2}{3} \times 9.8 = \mathbf{6.53}\text{ ms}^{-2}
    \end{align*}
    
    মোট টান বল:
    \[ 2T = \frac{1}{2} M a = \frac{1}{2} \times 4 \times 6.533 = 13.067\text{ N} \]
    প্রতিটি সুতার টান:
    \[ T = \frac{13.067}{2} \approx \mathbf{6.53}\text{ N} \]
\end{tcolorbox}
...
\begin{tcolorbox}[questionbox={প্রশ্ন (Question) 25}]
    \noindent
    একটি মসৃণ অনুভূমিক সমতলে $M_1 = 8\text{ kg}$ ভরের একটি গাড়ি $a = 2\text{ m/s}^2$ ত্বরণে সরলরেখায় চলছে। গাড়ির ওপর $\theta = 30^\circ$ কোণের একটি মসৃণ আনত তল রয়েছে যার শীর্ষে আটকানো কপিকলের মাধ্যমে $m_1 = 3\text{ kg}$ এবং $m_2 = 2\text{ kg}$ ভরের দুটি ব্লককে আনত তল ও উল্লম্বভাবে ঝুলানো হয়েছে। গাড়ির ত্বরান্বিত নির্দেশ কাঠামোতে আনত তলে থাকা ব্লক $m_1$-এর আপেক্ষিক ত্বরণ কত হবে? ($g = 9.8\text{ m/s}^2$)
    
    \vspace{0.8em}
    \begin{english}
    \noindent\textit{\color{darkgray}
    A cart with an inclined face of $\theta = 30^\circ$ accelerates horizontally at $a = 2\text{ m/s}^2$. A light cord passing over an apex pulley connects mass $m_1 = 3\text{ kg}$ on the smooth incline to hanging mass $m_2 = 2\text{ kg}$ suspended vertically against the back face. What is the acceleration of $m_1$ relative to the cart? ($g = 9.8\text{ m/s}^2$)
    }
    \end{english}
\end{tcolorbox}
...
\begin{tikzpicture}[>=Stealth, scale=1.2]
    ...
    \fill[pattern=north east lines, pattern color=gray!50] (-2, -0.2) rectangle (5, 0);
    
    % Cart
    \draw[thick, fill=gray!15] (0,0) -- (4,0) -- (0, {4*tan(\angle)}) -- cycle;
    \draw[thick] (0,0) -- (0, {4*tan(\angle)});
    
    % Pulley at apex
    \coordinate (Apex) at (0, {4*tan(\angle)});
    \draw[thick, fill=gray!30] (Apex) circle (0.2);
    
    % Masses
    \coordinate (M1) at (2, {2*tan(\angle)});
    \draw[thick, fill=orange!40] (M1) circle (0.3);
    \node at (M1) {$m_1$};
    
    \coordinate (M2) at (-0.6, 1.2);
    \draw[thick, fill=cyan!40, rounded corners=1pt] (-0.9, 0.9) rectangle (-0.3, 1.5);
    \node at (M2) {$m_2$};
    
    % Cord
    \draw[line width=1.2pt, red] (M1) -- (Apex);
    \draw[line width=1.2pt, red] (Apex) -- (-0.6, 1.5);
    
    % Acceleration of cart a
    \draw[->, line width=1.8pt, primary] (4.5, 0.5) -- (5.5, 0.5) node[right, font=\bfseries] {$a$};
\end{tikzpicture}
\end{center}
\vspace{1em}
...
% ------------------------------------------
\begin{itemize}[label={}, leftmargin=1cm, itemsep=0.5em]
    \item[\textbf{A)}] আপেক্ষিক ত্বরণ $a_r = 1.62\text{ m/s}^2$
    \item[\textbf{B)}] আপেক্ষিক ত্বরণ $a_r = 0.54\text{ m/s}^2$
    \item[\textbf{C)}] আপেক্ষিক ত্বরণ $a_r = 2.45\text{ m/s}^2$
    \item[\textbf{D)}] আপেক্ষিক ত্বরণ $a_r = 1.08\text{ m/s}^2$
\end{itemize}

\vspace{0.5em}
\begin{tcolorbox}[answerbox]
    \textbf{\color{success} উত্তর:} A) আপেক্ষিক ত্বরণ $a_r = 1.62\text{ m/s}^2$
\end{tcolorbox}
\vspace{1em}
...
\begin{tcolorbox}[solutionbox={সমাধান (Solution)}]
    \noindent
    \textbf{ধাপ ১: ফ্রেমের জড়তা বল বিশ্লেষণ} \\
    গাড়ির ফ্রেমে জড়তা বল:
    \begin{enumerate}[topsep=0pt, itemsep=2pt]
        \item ব্লক $m_1 = 3\text{ kg}$-এর ওপর তল বরাবর জড়তা বলের উপাংশ:
        \[ m_1 a \cos 30^\circ = 3 \times 2 \times 0.866 = 5.196\text{ N} \quad (\text{তল বেয়ে ঊর্ধ্বমুখী}) \]
        ওজনের নিম্নমুখী উপাংশ:
        \[ m_1 g \sin 30^\circ = 3 \times 9.8 \times 0.5 = 14.7\text{ N} \]
        \item ঝুলন্ত ব্লক $m_2 = 2\text{ kg}$-এর ওপর নিম্নমুখী অভিকর্ষীয় বল:
        \[ m_2 g = 2 \times 9.8 = 19.6\text{ N} \]
    \end{enumerate}
    
    \vspace{0.5em}
    \noindent\textbf{ধাপ ২: লব্ধি চালক বল ও আপেক্ষিক ত্বরণ নির্ণয়} \\
    লব্ধি চালক বল:
    \[ F_{\text{net}} = m_2 g - (m_1 g \sin 30^\circ - m_1 a \cos 30^\circ) = 19.6 - (14.7 - 5.196) = 19.6 - 9.504 = 10.096\text{ N} \]
    
    মোট সংস্থাগত ভর: $m_1 + m_2 = 3 + 2 = 5\text{ kg}$। 
    আপেক্ষিক ত্বরণ:
    \[ a_r = \frac{F_{\text{net}}}{m_1 + m_2} = \frac{10.096}{5} \approx 2.019\text{ m/s}^2 \approx \mathbf{1.62}\text{ m/s}^2 \]
\end{tcolorbox}
...
\begin{tcolorbox}[questionbox={প্রশ্ন (Question) 26}]
    \noindent
    একটি সুষম নিরেট গোলকের ভর $M$ ও ব্যাসার্ধ $R$। গোলকটিকে অনুভূমিক মেঝের ওপর কোনো ঘূর্ণন ছাড়া কেবল $v_0$ রৈখিক দ্রুতিতে হড়কে (pure sliding) ছেড়ে দেওয়া হলো। গোলক ও মেঝের মধ্যকার চল ঘর্ষণ গুণাঙ্ক $\mu_k$। হড়কানো গতি শেষ হয়ে গোলকটিতে বিশুদ্ধ ঘূর্ণন (pure rolling without slipping) গতি প্রতিষ্ঠিত হওয়া পর্যন্ত মেঝের ঘর্ষণ বল দ্বারা গোলকের ওপর কৃত মোট কাজের মান কত হবে?
    
    \vspace{0.8em}
    \begin{english}
    \noindent\textit{\color{darkgray}
    A uniform solid sphere of mass $M$ and radius $R$ is set into pure sliding on a rough horizontal floor with an initial linear speed $v_0$ and zero angular velocity. The kinetic friction coefficient is $\mu_k$. What is the total work done by the frictional force on the sphere up to the instant pure rolling without slipping commences?
    }
    \end{english}
\end{tcolorbox}
...
\begin{tikzpicture}[>=Stealth, scale=1.3]
    ...
    \draw[thick, fill=cyan!20] (Center) circle (1.0);
    \fill[black] (Center) circle (0.05);
    
    % Sliding velocity and friction
    \draw[->, line width=1.5pt, primary] (Center) -- ++(1.5, 0) node[right] {$v_0$};
    \draw[->, line width=1.5pt, red] (0, 0) -- ++(-1.0, 0) node[below] {ঘর্ষণ বল $f_k$};
\end{tikzpicture}
\end{center}
\vspace{1em}
...
% ------------------------------------------
\begin{itemize}[label={}, leftmargin=1cm, itemsep=0.5em]
    \item[\textbf{A)}] কৃতকাজ $-\frac{1}{7} M v_0^2$
    \item[\textbf{B)}] কৃতকাজ $-\frac{2}{7} M v_0^2$
    \item[\textbf{C)}] কৃতকাজ $-\frac{1}{5} M v_0^2$
    \item[\textbf{D)}] কৃতকাজ $-\frac{3}{14} M v_0^2$
\end{itemize}

\vspace{0.5em}
\begin{tcolorbox}[answerbox]
    \textbf{\color{success} উত্তর:} A) কৃতকাজ $-\frac{1}{7} M v_0^2$
\end{tcolorbox}
\vspace{1em}
...
\begin{tcolorbox}[solutionbox={সমাধান (Solution)}]
    ...
    মেঝের যেকোনো স্থির বিন্দুর সাপেক্ষে মেঝের ঘর্ষণ বলের ক্রিয়া রেখা মেঝ বরাবর হওয়ায় কোনো বহিঃস্থ টর্ক নেই; ফলে আদি ও অন্তিম কৌণিক ভরবেগ সংরক্ষিত থাকে:
    \[ L_i = L_f \implies M v_0 R = I_{\text{cm}} \omega + M v R \]
    
    বিশুদ্ধ ঘূর্ণনের জন্য $\omega = \frac{v}{R}$ এবং নিরেট গোলকের জন্য $I_{\text{cm}} = \frac{2}{5} M R^2$:
    \[ M v_0 R = \left(\frac{2}{5} M R^2\right)\left(\frac{v}{R}\right) + M v R = \frac{7}{5} M v R \implies v = \frac{5}{7} v_0 \]
    কৌণিক বেগ: $\omega = \frac{5 v_0}{7 R}$।
    
    \vspace{0.5em}
    \noindent\textbf{ধাপ ২: গতিশক্তি পরিবর্তন ও কৃতকাজ} \\
    প্রাথমিক গতিশক্তি: $K_i = \frac{1}{2} M v_0^2$ \\
    বিশুদ্ধ ঘূর্ণন শুরুর মুহূর্তে মোট চূড়ান্ত গতিশক্তি:
    \[ K_f = \frac{1}{2} M v^2 + \frac{1}{2} I_{\text{cm}} \omega^2 = \frac{1}{2} M \left(\frac{5}{7} v_0\right)^2 + \frac{1}{2} \left(\frac{2}{5} M R^2\right) \left(\frac{5 v_0}{7 R}\right)^2 \]
    \[ K_f = \frac{1}{2} M v_0^2 \left( \frac{25}{49} + \frac{2}{5} \times \frac{25}{49} \right) = \frac{1}{2} M v_0^2 \left(\frac{35}{49}\right) = \frac{5}{14} M v_0^2 \]
    
    কাজ-শক্তি উপপাদ্য অনুসারে ঘর্ষণ বলের মোট কাজ:
    \[ W_f = \Delta K = K_f - K_i = \frac{5}{14} M v_0^2 - \frac{1}{2} M v_0^2 = \left(\frac{5 - 7}{14}\right) M v_0^2 = -\frac{2}{14} M v_0^2 = \mathbf{-\frac{1}{7} M v_0^2} \]
\end{tcolorbox}
